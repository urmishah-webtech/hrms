                                        ...
                                        <td>
                                            <div class="dropdown action-label">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ url('change_appraisal_status').'/1'.'/'.@$val->id }}"><i class="fa fa-dot-circle-o text-success"></i>Active</a>
                                                    <a class="dropdown-item" href="{{ url('change_appraisal_status').'/0'.'/'.@$val->id }}"><i class="fa fa-dot-circle-o text-danger"></i>Inactive</a>
                                                </div>                                                
                                            </div>
                                        </td>
                                        <td class="text-right">
