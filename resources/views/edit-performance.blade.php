                                            ...
                                            <td>                                               
												<div class="form-group">
													<label for="name1"> Manager's Name</label>
														...
														@endisset 
													<select class="form-control" name="man_id" id="edit_manager_id" required  disabled >
												...
												<div class="review-header text-center" style="border:none; display:none" id="personal_exce_next">
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive1">
                               ...
                               <input type="hidden" name="getid" value="@if(isset($add_appraiseest_id)){{ $val->emp_id}}@endif">                                 
								...
								@if(Auth::user()->role_id != 3 && Auth::user()->role_id != 1 && Auth::user()->role_id != 5 && Auth::user()->id != $emps->id)
                                <div class="review-header text-center">
									<button type="submit" name="email_setting_submit" class="btn btn-primary submit-btn">Save &amp; update</button>
								</div>
								@endif
