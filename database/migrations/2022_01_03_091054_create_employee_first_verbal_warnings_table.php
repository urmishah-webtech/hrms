...
class CreateEmployeeFirstVerbalWarningsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_first_verbal_warnings', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('employee_first_verbal_warnings');
    }
}
