                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="profile" class="text-primary">John Doe <span>#0001</span></a>
                                                </h2>
                                            </td>
                                            <td>Employee</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="profile" class="text-primary">Richard Miles <span>#0002</span></a>
                                                </h2>
                                            </td>
                                            <td>Employee</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="profile" class="text-primary">John Smith <span>#003</span></a>
                                                </h2>
                                            </td>
                                            <td>Employee</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="profile" class="text-primary">Mike Litorus <span>#004</span></a>
                                                </h2>
                                            </td>
                                            <td>Employee</td>
                                        ...
                                        <tr>
                                            <td>
                                                <h2 class="table-avatar">
                                                    ...
                                                    <a href="profile" class="text-primary">Wilmer Deluna <span>#005</span></a>
                                                </h2>
                                            </td>
                                            <td>Employee</td>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarthr_laravel\blue\resources\views/employee-reports.blade.php ENDPATH**/ ?>