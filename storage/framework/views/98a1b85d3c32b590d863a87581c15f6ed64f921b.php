                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped custom-table mb-0 datatable">
                                ...
                                <?php $__currentLoopData = $appraisal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(@$val->employee->designation->name); ?> </td>
                                        <td><?php echo e(@$val->employee->department->name); ?></td>
                                        <td><?php echo e(@$val->appraisal_date); ?></td>
                                        <td>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item editAppraisalBtn" href="#" data-appraisal_date="<?php echo e(@$val->appraisal_date); ?>" data-status="<?php echo e(@$val->status); ?>" data-ability_to_meet_deadline="<?php echo e(@$val->ability_to_meet_deadline); ?>" data-efficiency="<?php echo e(@$val->efficiency); ?>" data-attendance="<?php echo e(@$val->attendance); ?>" data-quality_of_work="<?php echo e(@$val->quality_of_work); ?>" data-conflict_management="<?php echo e(@$val->conflict_management); ?>" data-presentation_skills="<?php echo e(@$val->presentation_skills); ?>" data-critical_thinking="<?php echo e(@$val->critical_thinking); ?>" data-administration="<?php echo e(@$val->administration); ?>" data-teamwork="<?php echo e(@$val->teamwork); ?>" data-management="<?php echo e(@$val->management); ?>" data-professionalism="<?php echo e(@$val->professionalism); ?>" data-marketing="<?php echo e(@$val->marketing); ?>" data-integrity="<?php echo e(@$val->integrity); ?>" data-cust="<?php echo e(@$val->customer_experience); ?>" data-emp-id="<?php echo e(@$val->employee_id); ?>" data-id="<?php echo e(@$val->id); ?>" data-toggle="modal" data-target="#edit_appraisal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                                    <a class="dropdown-item deleteAppraisalBtn" data-id="<?php echo e(@$val->id); ?>" href="#" data-toggle="modal" data-target="#delete_appraisal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
            ...
            <div id="add_appraisal" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route('add_appraisal')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-sm-12">
            ...
            <div id="edit_appraisal" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo e(route('edit_appraisal')); ?>" method="post">
                            <?php echo csrf_field(); ?>   
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\orange\resources\views/performance-appraisal.blade.php ENDPATH**/ ?>