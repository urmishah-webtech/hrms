                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto float-right ml-auto">
                                <a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_categories"><i class="fa fa-plus"></i> Add Revenues</a>
                            </div>
                        </div>
                    </div>
                    <!-- /Page Header -->
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\smarthr_laravel\blue\resources\views/budget-revenues.blade.php ENDPATH**/ ?>